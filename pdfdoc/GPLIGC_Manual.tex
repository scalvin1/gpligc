...
% removed pdftex, because this creates an "option clash" because of some catoptions misbehaviour
% catoptions used by menukeys
...
\usepackage[colorlinks, bookmarksnumbered=true, linkcolor=blue, citecolor=blue, urlcolor=blue]{hyperref}
